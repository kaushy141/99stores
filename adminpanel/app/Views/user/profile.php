  ...
  <div class="col-12">
    <div class="card mb-4">
      <div class="user-profile-header-banner">
        <img src="<?php echo base_url('public/img/profile_banner.png')?>" alt="Banner image" class="rounded-top">
      </div>
      <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
          <?= img(array("src"=>session()->get('image'), "alt"=>session()->get('fname'), "class"=>"d-block h-auto ms-0 ms-sm-4 rounded user-profile-img"))?> 
        </div>
        <div class="flex-grow-1 mt-3 mt-sm-5">
          <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
            <div class="user-profile-info">
              <h4><?php echo session()->get('fname')?> <?php echo session()->get('lname')?></h4>
              <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">
                <li class="list-inline-item fw-semibold">
                  <i class="bx bx-pen"></i> <?php echo session()->get('type_name')?>
                </li>
                <li class="list-inline-item fw-semibold">
                  <i class="bx bx-map"></i> Vatican City
                </li>
                <li class="list-inline-item fw-semibold">
                  <i class="bx bx-calendar-alt"></i> Joined <?php echo date("d M, Y", strtotime(session()->get('created_date')))?>
                </li>
              </ul>
            </div>
            <a href="javascript:void(0)" class="btn btn-<?php echo statusClass(session()->get('status'))?> text-nowrap">
              <i class="bx bx-user-check"></i> <?php echo session()->get('status')?>
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <ul class="list-unstyled mb-4 mt-3">
          <li class="d-flex align-items-center mb-3"><i class="bx bx-user"></i><span class="fw-semibold mx-2">Full Name:</span> <span><?php echo session()->get('fname')?> <?php echo session()->get('lname')?></span></li>
          <li class="d-flex align-items-center mb-3"><i class="bx bx-check"></i><span class="fw-semibold mx-2">Status:</span> <span><?php echo session()->get('status')?></span></li>
          <li class="d-flex align-items-center mb-3"><i class="bx bx-envelope"></i><span class="fw-semibold mx-2">Email:</span> <span><?php echo session()->get('email')?> </span></li>
          <li class="d-flex align-items-center mb-3"><i class="bx bx-phone"></i><span class="fw-semibold mx-2">Mobile:</span> <span><?php echo session()->get('mobile')?></span></li>
        ...
        <ul class="list-unstyled mb-4 mt-3">
          <li class="d-flex align-items-center mb-3"><i class="bx bx-phone"></i><span class="fw-semibold mx-2">Contact:</span> <span><?php echo session()->get('mobile')?></span></li>
          <li class="d-flex align-items-center mb-3"><i class="bx bx-envelope"></i><span class="fw-semibold mx-2">Email:</span> <span><?php echo session()->get('email')?></span></li>
        </ul>
        ...
        <ul class="timeline ms-2">
          ...
          <li class="timeline-item timeline-item-transparent">
            ...
            <div class="timeline-event">
              ...
              <p class="mb-2">Sent by Mollie Dixon <img src="../../assets/img/avatars/4.png" class="rounded-circle ms-3" alt="avatar" width="20" height="20"></p>
              <div class="d-flex flex-wrap gap-2">
                <a href="javascript:void(0)" class="me-3">
                  <img src="../../assets/img/icons/misc/pdf.png" alt="Document image" class="me-2" width="20">
                  <span class="h6">App Guidelines</span>
                </a>
                <a href="javascript:void(0)">
                  <img src="../../assets/img/icons/misc/doc.png" alt="Excel image" class="me-2" width="20">
